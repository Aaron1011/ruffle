...
use crate::avm1::{Activation, ActivationIdentifier, AvmString, Object as Avm1Object, TObject, Value as Avm1Value};
use crate::avm2::{Avm2, Object as Avm2Object, Event as Avm2Event, EventData as Avm2EventData};
    ...
    pub fn update_timers(context: &mut UpdateContext<'_, 'gc, '_>, dt: f64) -> Option<f64> {
            ...
            < cur_time
        {
            ...
            match callback {
                ...
                TimerCallback::Avm1Method { this, method_name, params } => {
                ...
                TimerCallback::TimerEvent { this } => {
                    let mut timer_event = Avm2Event::new("timer", Avm2EventData::Timer);
                    timer_event.set_bubbles(false);
                    timer_event.set_cancelable(false);
                    if let Err(e) = Avm2::dispatch_event(&mut activation.context, timer_event, this) {
                        log::error!(
                            "Encountered AVM2 error when broadcasting `timer` event: {}",
                            e
                        );
                    }
                }
